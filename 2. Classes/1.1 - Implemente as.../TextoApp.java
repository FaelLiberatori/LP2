public class TextoApp {
    public static void main (String[] args) {
        Texto texto1 = new Texto(10,10,22,"Arial","Texto grande",false,false,true,false);
        texto1.print();
    }
}
...
class Texto {
    ...
    // Saida:
    // Texto de fonte Arial, de tamanho 22 na posicao (10,10) com texto "Texto grande" e sublinhado.
}